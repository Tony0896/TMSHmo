(function (S, _) {
    typeof exports == "object" && typeof module < "u"
        ...
        ? define(_)
        : ((S = typeof globalThis < "u" ? globalThis : S || self), (S.Zoomist = _()));
})(this, function () {
    var G, zt, P, yt, F, At, q, Mt, K, It, J, Ct, Q, xt, tt, $t, et, Nt, st, Bt, nt, Wt, it, Ht;
    ("use strict");
    var pe = Object.defineProperty;
    var Ee = (S, _, O) => (_ in S ? pe(S, _, { enumerable: !0, configurable: !0, writable: !0, value: O }) : (S[_] = O));
    var R = (S, _, O) => (Ee(S, typeof _ != "symbol" ? _ + "" : _, O), O),
        Se = (S, _, O) => {
            if (!_.has(S)) throw TypeError("Cannot " + O);
        };
    var D = (S, _, O) => {
        if (_.has(S)) throw TypeError("Cannot add the same private member more than once");
    ...
    const S = "",
        ...
        L = (n) => {
            const { width: t, height: e, top: s, left: i, bottom: a } = n.getBoundingClientRect();
            return { width: t, height: e, top: s, left: i, bottom: a };
        },
        Et = (n) => (n.length >= 2 ? Math.hypot(n[0].clientX - n[1].clientX, n[0].clientY - n[1].clientY) : 0),
        I = (n, t) => {
            for (const [e, s] of Object.entries(t)) typeof s == "string" && n.style.setProperty(e, s);
        },
        C = (n, t) => {
        ...
        x = (n = "div", t, e, s) => {
            ...
            return t && i.classList.add(...t.split(" ")), e && C(i, e), s && (i.innerHTML = s), i;
        },
        E = "zoomist",
        Zt = `${E}-container`,
        bt = `${E}-wrapper`,
        ...
        gt = { tabindex: "0", role: "button", type: "button", "aria-disabled": "false" },
        ...
        A = typeof window < "u" && typeof window.document < "u" && "ontouchstart" in window,
        ...
        re = { el: `.${$}` },
        ae = { el: null, inEl: null, outEl: null, resetEl: null, disabledClass: Ft },
...
`,
        fe = {
            ...
            zoomTo(n, t = !0) {
                ...
                const { clientX: c, clientY: l } = t,
                    ...
                    v = r ? z(p, u, -u) : p,
                    y = r ? z(g, f, -f) : g;
                return T(this.transform, { translateX: v, translateY: y }), this.emit("zoom", this, this.transform.scale), this;
            },
            move(n) {
                const {
                        options: { bounds: t },
            ...
            reset() {
                ...
                return T(this.transform, { scale: n, translateX: 0, translateY: 0 }), this.emit("reset", this), this;
            },
            destroy(n = !1) {
    ...
    class wt {
        ...
        destroySlider() {
            ...
            e === `.${$}` ? (a = t.sliderEl) == null || a.remove() : (r = t.sliderTrack) == null || r.remove(),
                s == null || s.abort(),
                (t.mounted = !1);
        }
        destroyZoomer() {
    ...
    return (
        ...
        (zt = function () {
            ...
            if (
                ...
                (this.data = { imageData: { originWidth: l, originHeight: d, width: o, height: h }, containerData: { width: r, height: c } }),
                A &&
                    (i || a) &&
                    (this.data.touchData = {
                        hypot: 0,
        ...
        scale(var(${Ot}, 0))`,
                    ...
                    set(d) {
                        ...
                        if (!(at(o) || l.transform.__scale__ === o)) {
                            ...
                            if (c && c.options.disabledClass) {
                                ...
                                h && (h.classList[o === i ? "add" : "remove"](f), C(h, { "aria-disabled": o === i ? "true" : "false" })),
                                    m && (m.classList[o === s ? "add" : "remove"](f), C(m, { "aria-disabled": o === s ? "true" : "false" })),
                                    u && (u.classList[o === a ? "add" : "remove"](f), C(u, { "aria-disabled": o === a ? "true" : "false" }));
                            }
                        }
                    },
                }),
                k(this.transform, "translateX", {
                    ...
                    set(d) {
                        const o = Y(d);
                        at(o) || l.transform.__translateX__ === o || ((l.transform.__translateX__ = o), I(e, { [vt]: `${o}px` }));
                    },
                }),
                k(this.transform, "translateY", {
                    ...
                    set(d) {
                        const o = Y(d);
                        at(o) || l.transform.__translateY__ === o || ((l.transform.__translateY__ = o), I(e, { [Tt]: `${o}px` }));
                    },
                }),
        ...
        (Mt = function (t) {
            const {
                    options: { zoomRatio: e, wheelReleaseOnMinMax: s, disableWheelingClass: i },
                } = this,
            ...
            const c = (o) => {
                    (o && o.button !== 0) ||
                        ...
                        !lt(o.target, i) &&
                            ...
                            this.emit("dragStart", this, { x: s.translateX, y: s.translateY }, o),
                ...
                l = (o) => {
                    ...
                    this.moveTo({ x: u, y: f }), T(a, { startX: X(o).clientX, startY: X(o).clientY }), this.emit("drag", this, { x: u, y: f }, o);
                },
                d = (o) => {
                    o.touches ||
                        ((this.states.dragging = !1),
        ...
        (Ct = function (t) {
            const {
                    data: e,
                    transform: s,
                    options: { maxScale: i, minScale: a, draggable: r, pinchable: c, bounds: l, dragReleaseOnBounds: d, disableDraggingClass: o },
                } = this,
            ...
            const u = (p) => {
                    ...
                    T(h, {
                        ...
                        r && ((this.states.dragging = !0), this.emit("dragStart", this, { x: s.translateX, y: s.translateY }, p)),
                        c && g.length === 2 && ((this.states.pinching = !0), this.emit("pinchStart", this, s.scale, p)),
                ...
                f = (p) => {
                    ...
                    if ((y && g.length === 2 && this.zoomTo(_t, !1), v)) {
                        const Lt = _t !== i && _t !== a && c ? Yt : 1,
                            ge = Y(Rt - h.imageLeft - (ot - h.widthDiff) - (h.startX - h.imageLeft) * Lt + s.translateX),
                            _e = Y(Xt - h.imageTop - (rt - h.heightDiff) - (h.startY - h.imageTop) * Lt + s.translateY);
                        this.moveTo({ x: ge, y: _e });
                    }
                    T(h, { hypot: M, startX: Rt, startY: Xt, imageTop: N, imageLeft: B, widthDiff: ot, heightDiff: rt }),
                        y && g.length === 2 && this.emit("pinch", this, s.scale, p),
                        v && this.emit("drag", this, { x: s.translateX, y: s.translateY }, p);
                },
                b = (p) => {
                    const g = p.touches;
                    if (!g) return;
                    ...
                    if (
                        (v && !g.length && ((this.states.dragging = !1), this.emit("dragEnd", this, { x: s.translateX, y: s.translateY }, p)),
                        y && g.length < 2 && ((this.states.pinching = !1), this.emit("pinchEnd", this, s.scale, p)),
                        v && g.length === 1)
                    ) {
                        const N = X(p).clientX,
                            B = X(p).clientY;
                    ...
                    g.length || (document.removeEventListener("touchmove", f), document.removeEventListener("touchend", b));
                };
            u(t);
        }),
        (Q = new WeakSet()),
        (xt = function () {
            ...
            new ResizeObserver(() => {
                ...
                T(this.data.containerData, { width: a, height: r }),
                    T(this.data.imageData, { originWidth: h, originHeight: m, width: u, height: f }),
        ...
        (Nt = function () {
            ...
            r.classList.add(`${$}-${i}`),
                k(e, "value", {
                    ...
                    set(o) {
                        e.__value__ !== o && ((e.__value__ = o), I(r, { [ie]: o.toString() }), C(d, { "aria-valuenow": o.toString() }));
                    },
                }),
                T(e, {
        ...
        (Wt = function () {
            ...
            const {
                ...
                l = (u, f, b, p, g) => {
                    const v = u === `.${b}`;
                    return !u || (!v && !_(u)) ? null : ((b = c.includes(u) ? `${b} ${Pt}` : b), v ? x(f, b, p, g) : H(u));
                },
                d = l(s, "div", V),
                o = l(i, "button", ut, Kt, de),
                h = l(a, "button", mt, Jt, ue),
                m = l(r, "button", ft, Qt, me);
            T(e, { controller: new AbortController(), zoomerEl: d, zoomerInEl: o, zoomerOutEl: h, zoomerResetEl: m }),
                d && (o && d.append(o), h && d.append(h), m && d.append(m), s === `.${V}` && t.append(d)),
